# -*- coding: utf-8 -*-
#
# OneGeology Documentation documentation build configuration file, created by
# sphinx-quickstart on Mon Mar  6 14:26:43 2017.
#
...
# Default language to highlight source code if not otherwise specified
# E.g. in literal blocks.
...
html_theme = 'onegeology'

# Theme options are theme-specific and customize the look and feel of a theme
# further.  For a list of options available for each theme, see the
# documentation.
#html_theme_options = {}
# For onegeology theme if finaldeploy is False then will try to refer to CSS
# javascript, images etc. on the server referred to as sharedroot
# When finaldeploy is True then will switch to include directives which will
# only work on the actual onegeology and beta servers.
html_theme_options = {
 "nosidebar" : True,
 "sharedroot" : "http://nercbgskwicms.ad.nerc.ac.uk:98",
 "finaldeploy" : False
}
...
#html_title = None
html_title = "Service provision"

# html_style option documented at http://www.sphinx-doc.org/en/stable/config.html#build-config
# not in auto-generated conf.py
html_style = "onegeology_cb.css"
...
# The default is True.
# If False then JavaScript search can't show extracts from matching content
...
htmlhelp_basename = 'OneGeologyDocumentationdoc'
...
latex_documents = [
  ('service_provision', 'OneGeologyDocumentation.tex', u'OneGeology Documentation',
   u'Marcus Sen, James Passmore', 'manual'),
]
...
man_pages = [
    ('service_provision', 'onegeologydocumentation', u'OneGeology Documentation',
     [u'Marcus Sen, James Passmore'], 1)
]
...
texinfo_documents = [
  ('service_provision', 'OneGeologyDocumentation', u'OneGeology Documentation',
   u'Marcus Sen, James Passmore', 'OneGeologyDocumentation', 'Documentation for OneGeology users and service providers',
   'Miscellaneous'),
]
...
epub_title = u'OneGeology Documentation'
epub_author = u'Marcus Sen, James Passmore'
epub_publisher = u'British Geological Survey'
epub_copyright = u'2017, NERC'

# The basename for the epub file. It defaults to the project name.
#epub_basename = u'OneGeology Documentation'
